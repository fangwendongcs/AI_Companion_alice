...
async function checkStateStoreContract() {
  const initialState = {
    ...
    memory: { enabled: false, used: false, sessionId: null, turnCount: 0, maxTurns: null },
    persona: { avatarId: null, personaId: null, name: null, tone: null },
    affect: { emotion: 'neutral', intensity: 0, tone: 'calm', voiceStyle: null, motionSlot: null },
    currentState: 'idle',
    isThinking: false,
    isSpeaking: false,
    isAnimating: false,
