...
export class AppController {
  ...
  syncMotionDebugState({ force = false } = {}) {
    ...
    const nextMotion = {
      ...
      assetQualityStatus: motion.assetQualityStatus || null,
      technicalStatus: motion.technicalStatus || null,
      productStatus: motion.productStatus || null,
      licenseStatus: motion.licenseStatus || null,
      ...
      retargetStatus: motion.retargetStatus || 'none',
      retargetProfile: motion.retargetProfile || '',
      sourceTrackCount: motion.sourceTrackCount ?? null,
